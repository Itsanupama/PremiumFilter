...
async def cb_handler(client: Client, query: CallbackQuery):
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                try:
                    ...
                    return await query.answer(' ˆ°• Gᴋᴋ™ ᴍᴏᴠɪᴇ ʟɪʙʀᴀʀʏ •°ˆ ')
            else:
    ...
    if query.data.startswith("file"):
        ...
        try:
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                ...
                await client.send_photo(chat_id=query.from_user.id, photo='https://graph.org/How-to-download-09-15-7', caption = f"<b>📕Nᴀᴍᴇ ➠ : <code>{files.file_name}</code> \n\n🔗Sɪᴢᴇ ➠ : {get_size(files.file_size)}</b>", 
        ...
        buttons = [[
            ...
            InlineKeyboardButton('💥 Mᴏᴠɪᴇ Uᴘᴅᴀᴛᴇs 💥', url='https://t.me/Movies_Telugu_Top'),
            InlineKeyboardButton('🔎 Sᴇᴀʀᴄʜ Gʀᴏᴜᴘ 🔍', url='https://t.me/+4tiVkQ6zeaMwZWM1')
            ],[
            InlineKeyboardButton('😅 ᴡᴀɴᴛ ᴛᴏ ᴊᴏɪɴ ᴘʀᴇᴍɪᴜᴍ ʙᴏᴛ? 😊', callback_data='sources')
            ],[
        ...
        buttons = [[
            InlineKeyboardButton('🤖 Uᴩᴅᴀᴛᴇs 😜', url='https://t.me/Movies_Telugu_Top'),
            ...
            InlineKeyboardButton('😅 ᴡᴀɴᴛ ᴛᴏ ᴊᴏɪɴ ᴘʀᴇᴍɪᴜᴍ ʙᴏᴛ? 😊', callback_data='source')
        ], [
        ...
        buttons = [[
            ...
            InlineKeyboardButton('😊 Cᴏɴᴛᴀᴄᴛ Me 😊', url='https://t.me/Iam_Channel_Admin')
        ], [
            InlineKeyboardButton('‹‹‹ Bᴀᴄᴋ', callback_data='start')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        buttons = [[
            ...
            InlineKeyboardButton('😊 Cᴏɴᴛᴀᴄᴛ Aᴅᴍɪɴ 😊', url='https://t.me/Iam_Channel_Admin')
        ], [
            InlineKeyboardButton('‹‹‹ Bᴀᴄᴋ', callback_data='about')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        buttons = [[
            InlineKeyboardButton('😪 Hᴏᴡ Tᴏ Oᴩᴇɴ Mʏ Lɪɴᴋs 💢', url='https://t.me/How_To_Open_shortLinks/19')
        ], [
            InlineKeyboardButton('📞 Cᴏɴᴛᴀᴄᴛ Aᴅᴍɪɴ 📟', callback_data='contact')
        ], [
            InlineKeyboardButton('‹‹‹ Bᴀᴄᴋ', callback_data='about')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        buttons = [[
            InlineKeyboardButton('😳 Cʀᴇᴀᴛᴏʀ 😳', url='https://t.me/Anonymous_owner_bot')
        ], [     
            InlineKeyboardButton('📞 Cᴏɴᴛᴀᴄᴛ Aᴅᴍɪɴ 📟', url='https://t.me/Iam_Channel_Admin')
        ], [  
            InlineKeyboardButton('‹‹‹ Bᴀᴄᴋ', callback_data='about')
    ...
    await query.answer(' ˆ°• Gᴋᴋ™ ᴍᴏᴠɪᴇ ʟɪʙʀᴀʀʏ •°ˆ ')
        ...
        if 2 < len(message.text) < 100:
            ...
            if not files:
                ...
                l = await message.reply_text(text=f"△ Hᴇʏ Fʀɪᴇɴᴅ {message.from_user.first_name} 😎,\n\nʏᴏᴜʀ ʀᴇQᴜᴇꜱᴛ ʜᴀꜱ ʙᴇᴇɴ ꜱᴇɴᴛ ᴛᴏ ᴏᴜʀ ᴀᴅᴍɪɴ'ꜱ ᴅᴀꜱʜʙᴏᴀʀᴅ !\n\nᴘʟᴇᴀꜱᴇ ᴋᴇᴇᴘ ꜱᴏᴍᴇ ᴘᴀᴛɪᴇɴᴄᴇ !\nᴛʜᴇʏ ᴡɪʟʟ ᴜᴘʟᴏᴀᴅ ɪᴛ ᴀꜱ ꜱᴏᴏɴ ᴀꜱ ᴘᴏꜱꜱɪʙʟᴇ.\n\n➟ 📝Cᴏɴᴛᴇɴᴛ Nᴀᴍᴇ : {search}\n\n➟ 👮 Rᴇǫᴜᴇsᴛᴇᴅ Bʏ Yᴏᴜ : {message.from_user.first_name}\n\n༺ @Movies_Telugu_Top༻\n\n🦋・‥☆Sᴜᴩᴩᴏʀᴛ Oᴜʀ Cʜᴀɴɴᴇʟ ☆‥・🦋\n╰┈➤・☆ @Movies_Telugu_Top ☆",
                                                                                                       reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("━ • │▌║  Aᴅᴅ Mᴇ Tᴏ Uʀ Gʀᴏᴜᴩ  ║▌│ • ━", url=f'http://t.me/{temp.U_NAME}?startgroup=true')],[InlineKeyboardButton("✪ Gᴋᴋ™ ᴍᴏᴠɪᴇ ʟɪʙʀᴀʀʏ ✪", url="https://t.me/Movies_Telugu_Top"), InlineKeyboardButton("✪ Sᴜᴩᴩᴏʀᴛ Gʀᴏᴜᴩ ✪", url="https://t.me/+4tiVkQ6zeaMwZWM1"), InlineKeyboardButton("✪ Rᴇᴩᴏ ✪", url="https://t.me/Movies_Telugu_Top")],[InlineKeyboardButton("╚»♥️Dᴇʟᴇᴛᴇ Tʜɪs Mᴇssᴀɢᴇ ♥️«╝", callback_data="close_data")]]))
